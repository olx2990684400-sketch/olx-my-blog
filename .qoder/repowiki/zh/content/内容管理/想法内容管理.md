...
## 更新摘要
**变更内容**
- MomentsEditor组件进行了重大重构，从直接GitHub API调用改为使用代理API函数
- 引入了更复杂的文件存在性检查机制、条件文件操作和调试功能
- 新增了清理逻辑，包括旧文件的自动删除
- 更新了提交流程，采用更安全的代理API集成和迁移策略
...
- GitHub API代理
  ...
  - Web Worker代理：src/workers/github-proxy.js
...
WP["Web Worker代理<br/>src/workers/github-proxy.js"]
...
**图表来源**
- [src/components/edit/MomentsEditor.svelte:1-1169](file://src/components/edit/MomentsEditor.svelte#L1-L1169)
...
- [src/utils/editMode.ts:1-873](file://src/utils/editMode.ts#L1-L873)
- [src/utils/draftHelpers.ts](file://src/utils/draftHelpers.ts)
- [api/github.js:1-17](file://api/github.js#L1-L17)
- [src/workers/github-proxy.js:1-278](file://src/workers/github-proxy.js#L1-L278)
...
- GitHub API代理
  ...
  - **更新** Web Worker代理支持GitHub App认证和权限诊断功能。
...
**图表来源**
- [src/components/edit/MomentsEditor.svelte:19-1169](file://src/components/edit/MomentsEditor.svelte#L19-L1169)
...
- 迁移与清理
  ...
  - **新增** 自动清理旧文件，包括public/moments.json的删除。
- **新增** 自动备份
  - 通过GitHub的版本控制实现自动备份。
  - 支持分支管理和标签标注。
